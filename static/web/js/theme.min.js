...
(function (e) {
  ...
  APP.colorModes = {
    ...
    setLightMode: function () {
      ...
      const colorModeContainer = document.querySelector(".color-modes");
      if (!colorModeContainer) return;
      ...
      document.querySelectorAll(".color-modes").forEach(container => {
        const activeIcon = container.querySelector(".theme-icon-active use");
        const selected = container.querySelector('[data-bs-theme-value="light"]');
        const iconHref = selected.querySelector("svg use").getAttribute("href");
  
        selected.classList.add("active");
        selected.setAttribute("aria-pressed", "true");
        activeIcon.setAttribute("href", iconHref);
      });
    }
  };
